...
import { Component, LightProbeGroup, Node, Scene, Canvas } from 'cc';
...
export declare class GizmoManager extends EventEmitter implements ISceneEvents, LightProbeEditModeListener {
    ...
    walkAllLightProbeGizmoListener(callback: (e: LightProbeGizmo) => void, lightProbeGroup: LightProbeGroup): void;
